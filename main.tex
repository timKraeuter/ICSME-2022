...
\end{figure}
% Add and example matching Fig. 1 as an object diagram from the debugger.
% Link and mention object diagram modeler

% State how many downloads we have atm
% Introduce the two components but do not describe them here.
...
% TODO: What makes our visual debugger unique? Foreshadowing to the main contributions in the conclusion.
