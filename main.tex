...
The visual debugger tool currently has 1804 unique downloads\footnote{\label{footnote:pluginStats}Last checked on March 8, 2022, see \cite{VisualDebuggerIntelliJ}.} and positive reviews.
...
Furthermore, the visualization component is independent of the programming language which is debugged, and can potentially be reused to debug different object-oriented programming language.
...
The object diagram modeler is an open-source tool to create object diagrams in the browser \cite{ObjectDiagramModeler2022}.
