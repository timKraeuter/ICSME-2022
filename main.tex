...
\maketitle
% Introduction: TODO: Better Motivation
...
% Related work: done, maybe relation to my main work or put that in the conclusion?
% Conclusion & future work: TBD
...
% Conclude
The main contribution is the open-source visual debugging tool we have created.
...
The scalability of our visual debugger must be similar to the scalability of present textual debuggers, such that our tool can be adopted in the industry.
...
% Third, \cite{krauterBehavioralConsistencyHeterogeneous2021} + cite ECMFA paper.
