...
The visual debugger tool currently has 2662 unique downloads\footnote{\label{footnote:pluginStats}Last checked on 13th of June, 2022, see \cite{VisualDebuggerIntelliJ}.} and only positive reviews.
